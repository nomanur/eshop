            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="single-banner text-center">
                        <img style="height: 200px;" src="{{asset('img/'. $catproduct->image)}}" alt="#">
                        <div class="content text-center w-100">
                            <p>{{$catproduct->title}}</p>
                            <h3>{!! $catproduct->description !!}</h3>
                            <a href="{{route('front.singleproduct', $catproduct->id)}}">Read More</a>
                        </div>
                    </div>
                </div>
                <!-- /End Single Banner  -->
